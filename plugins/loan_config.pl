sub loan_config {
    return {
        ...
        SUPER_MOB_GRACE_PERIOD_MINUTES => 10, # Grace period after killing player before it can spawn again.
        SUPER_MOB_DEPOP_MINUTES => 1, # Supermob depop time in minutes
        BASE_LOAN_DURATION_MINUTES => 1440, # Loan duration in minutes (set to 1 for testing, 1440 for 24h, 2880 for 48h)
        ...
        BUCKET_KEYS => {
            ...
            grace_period => "loan_kill_grace_period_%s",
        }
    };
}
1;
